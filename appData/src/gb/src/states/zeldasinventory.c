...
#ifndef ZELDAS_INVENTORY_CAMERA_DEADZONE
#define ZELDAS_INVENTORY_CAMERA_DEADZONE 24
#endif
...
void zeldasinventory_init() BANKED {
    camera_offset_x = 0;
    camera_offset_y = 0;
    camera_deadzone_x = ZELDAS_INVENTORY_CAMERA_DEADZONE;
    camera_deadzone_y = ZELDAS_INVENTORY_CAMERA_DEADZONE;
