...
export const TriggerPrefabSelectButton: FC<TriggerPrefabSelectButtonProps> = ({
  name,
  value,
  onChange,
}) => {
  ...
  const prefabIds = useAppSelector(triggerPrefabSelectors.selectIds);
  ...
  const prefabName =
    (prefab && triggerName(prefab, prefabIds.indexOf(prefab.id))) ??
    l10n("FIELD_NONE");
